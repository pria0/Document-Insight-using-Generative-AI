...
LOCAL_HOST_PORT = "http://127.0.0.1:8000"
...
CHATBOT_QUESTION_LIMIT = int(os.environ.get('CHATBOT_QUESTION_LIMIT', 0))
DEMO_CHATBOT_QUESTION_LIMIT = int(os.environ.get('DEMO_CHATBOT_QUESTION_LIMIT', 0))

BASE_FRONTEND_URL=os.environ.get('BASE_FRONTEND_URL', '')
BASE_DOC_GPT_FRONTEND_URL=os.environ.get('BASE_DOC_GPT_FRONTEND_URL', '')
